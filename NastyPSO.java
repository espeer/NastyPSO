...
class NastyPSO {
    ...
    static final long MBIG = 1000000000;
    static final long MSEED = 161803398;
	...
	Random r = new Random();
	idnum = - r.nextInt(2147483647);
	position = new double [size][dimension];
	bestpos = new double [size][dimension];
	velocity = new double [size][dimension];
	...
	for (int i = 0; i < repeats; ++i) {
	    ...
	    System.out.print(i + " : " + bestfit[gbest] + " [");
	    for (int j = 0; j < dimension - 1; ++j) {
		System.out.print(position[gbest][j] + ", ");
	    }
	    System.out.println(position[gbest][dimension - 1] + "]");
	}
	System.exit(0);
    }   
}
